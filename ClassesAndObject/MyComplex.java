public class MyComplex {
    ...
    public static void main(String[] args) {
        MyComplex MC = new MyComplex(5, 7);
        MC.setImag(5);
        System.out.println("Imaginary Number: " + MC.getImag());
        MC.setReal(4);
        
        System.out.println("Real Number: " + MC.getReal());
        System.out.println("COngugate: "+MC.conjugate());
        //MC.setValue(5, 7);
